...
def getopenairesponse(userquestion):
...
###################
st.title("Chat Support - Help Centre")
name = st.sidebar.text_input("Enter your name", 'Deepa')
st.write(f"Hello {name}!")

question = st.text_input("What's Your Question", 'enter your query')


if st.button('Get Answer'):
    answer = getopenairesponse(question)
